 ...
 * 
 * @author psenin
 * Modified by Sayantan and Gajanana: For adding timestamp to each word, when a time series is converted to BOW
 * 
 */
public class WordBag implements Cloneable {
  ...
  // changed for getting the Temporal position of a word w.r.t Time series
  public HashMap<String, Integer > words_with_time; // "aaaa",'1' ; "bbbb",'2'........ i.e. the order in which the words appear in time
  public int timePosition_Of_last_word;
  ...
  public WordBag(String bagLabel) {
    ...
    this.words_with_time = new HashMap<String, Integer>();//Added by Sayantan
  }
  ...
  //getter-setter added for stroing the time association
  //set - add words
  //get - get the whole map with words and their 'temporal stamp' i.e. the key/value
public HashMap<String, Integer> getWords_with_time() {
	return this.words_with_time;
}

public void setWords_with_time(String word, Integer position_in_time) {
	this.words_with_time.put(word, position_in_time);
}

public int getTimePosition_Of_last_word() {
	return timePosition_Of_last_word;
}

public void setTimePosition_Of_last_word(int timePosition_Of_last_word) {
	this.timePosition_Of_last_word = timePosition_Of_last_word;
}
